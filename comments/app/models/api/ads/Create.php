        ...
        try {
            ...
            if (empty($find["_id"])) {
                ...
                if (!empty($commentID)) {
                    ...
                    $mdb->ads->updateOne(["_id" => $adID, "comments.id" => (int) $commentID], ['$push' => ["comments.$.comments_id" => $comLeng], '$inc' => ['comments.$.ansversLength' => 1]]);
                }else{
                    $mdb->ads->updateOne(["_id" => $adID], ['$push' => ["comments_id" => $comLeng]]);
                }
            }
