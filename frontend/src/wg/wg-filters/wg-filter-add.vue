		...
		<div class="row">
			...
			<div class="col_12" v-show="tabs=='city'">
				<div class="wg-filter-add__content">
					...
					<div class="row">
						<div class="col_12">
							<wg-multiple-location :caption="'Страна, регион, город'"></wg-multiple-location>
						</div>
					</div>
				</div>
			</div>
			<div class="col_12" v-show="tabs=='model'">
				<div class="wg-filter-add__content">
					...
					<div class="row">
						<div class="col_12">
							<wg-multiple-location :caption="'Тип, фирма, модель'"></wg-multiple-location>
						</div>
					</div>
				</div>
			</div>
			<div class="col_12" v-show="tabs=='param'">
				<div class="wg-filter-add__content">
					...
					<div class="row">
						<div class="col_6">
							<ui-text value="" caption="Цена от"></ui-text>
						</div>
						<div class="col_5 col_offset-1">
							<ui-text value="" caption="до"></ui-text>
						</div>
					</div>
					<div class="row">
						<div class="col_6">
