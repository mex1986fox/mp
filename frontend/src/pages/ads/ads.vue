  ...
  <layout>
            ...
            <div class="row">
              <div class="col-12">
                <div class="wg-content-frame wg-content-frame_left wg-content-frame__padding">
                  <div @click="isShowFormAdd"
                       class="ui-button ui-button_red pg-ads__button-add">добавить объявление</div>
                </div>
              </div>
              <div class="row">
                <div class="col-12">
                  <div class="wg-content-frame wg-content-frame_left wg-content-frame__padding">
                    <div @click="showFilterAdd=true"
              ...
              <div class="wg-content-frame wg-content-frame_left">
                <div class="ui-avatar-block wg-card-ad__avatar-block"
                  ...
                  <div class="ui-avatar">
                    ...
                    <img alt=""
                         src="http://photos-users.ru/public/photos/avatars/6/Koala.jpg">
                  </div>
    ...
    <div class="row">
      ...
      <ui-blind @onHide="showMessenger=!showMessenger"
        ...
        <div class="container">
          <div class="row">
            <div class="col_8 col_offset-2 col-nbook_10 col-nbook_offset-1 col-tablet_12 col-tablet_offset-0 col-phone_6 col-phone_offset-0">
